...
class MonoDETRConfig(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        num_queries (`int`, *optional*, defaults to 50):
        ...
        decoder_self_attn (`bool`, *optional*, defaults to `True`):
            Whether or not to use self-attention in the decoder.
        decoder_depth_residual (`bool`, *optional*, defaults to `True`):
            Whether or not to use depth residual in the decoder.
        group_num (`int`, *optional*, defaults to 11):
            Number of grouped queries in the decoder GQA self-attention.
